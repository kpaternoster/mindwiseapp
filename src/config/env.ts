...
export const API_ENDPOINTS = {
  ...
  MINDFUL_HALF_SMILE_PRACTICE: `${BASE_API_URL}/mindful-half-smile-practice`,
  MINDFUL_HALF_SMILE_PRACTICE_BY_ID: (id: string) => `${BASE_API_URL}/mindful-half-smile-practice/${id}`,
  EMOTION_MAPPING: `${BASE_API_URL}/emotion-mapping`,
  EMOTION_MAPPING_BY_ID: (id: string) => `${BASE_API_URL}/emotion-mapping/${id}`,
  HALF_SMILE_IN_ACTION: `${BASE_API_URL}/half-smile-in-action`,
  HALF_SMILE_IN_ACTION_BY_ID: (id: string) => `${BASE_API_URL}/half-smile-in-action/${id}`,
  ANCHOR_PROMPTS: `${BASE_API_URL}/anchor-prompts`,
  ANCHOR_PROMPTS_BY_ID: (id: string) => `${BASE_API_URL}/anchor-prompts/${id}`,
  ACCEPTANCE_JOURNAL: `${BASE_API_URL}/acceptance-journal`,
  ...
  REFLECTIVE_PRACTICE: `${BASE_API_URL}/reflective-practice`,
  REFLECTIVE_PRACTICE_BY_ID: (id: string) => `${BASE_API_URL}/reflective-practice/${id}`,
  STOP_DRILL: `${BASE_API_URL}/stop-drill`,
  STOP_DRILL_BY_ID: (id: string) => `${BASE_API_URL}/stop-drill/${id}`,
  MINDFUL_PAUSE_TIMER: `${BASE_API_URL}/mindful-pause-timer`,
  MINDFUL_PAUSE_TIMER_BY_ID: (id: string) => `${BASE_API_URL}/mindful-pause-timer/${id}`,
  ROLE_PLAY: `${BASE_API_URL}/role-play`,
