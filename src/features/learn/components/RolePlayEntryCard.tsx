...
interface RolePlayEntryCardProps {
    entry: RolePlayEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const RolePlayEntryCard: React.FC<RolePlayEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
    ...
    return (
        ...
        >
            ...
            <Text style={[t.textRegular, { color: colors.text_secondary }]}>
                {entry.scenarioContext ? truncateText(entry.scenarioContext) : entry.rolePlayPartner ? truncateText(entry.rolePlayPartner) : 'No details entered.'}
            </Text>
        </View>
    );
};
