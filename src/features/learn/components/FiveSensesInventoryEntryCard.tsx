...
export interface FiveSensesInventoryEntry {
    id: string;
    date: string;
    time?: string;
    sight?: string;
...
interface FiveSensesInventoryEntryCardProps {
    entry: FiveSensesInventoryEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const FiveSensesInventoryEntryCard: React.FC<FiveSensesInventoryEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
