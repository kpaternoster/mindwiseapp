...
export interface CreateAPersonalizedToolkitEntry {
    id: string;
    date: string;
    time?: string;
    toolkit?: string;
...
interface CreateAPersonalizedToolkitEntryCardProps {
    entry: CreateAPersonalizedToolkitEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const CreateAPersonalizedToolkitEntryCard: React.FC<CreateAPersonalizedToolkitEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
