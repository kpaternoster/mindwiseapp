...
export interface DifferentActionIdentifyEmotionalUrgesEntry {
    id: string;
    date: string;
    time?: string;
    urgePairs?: Array<{
...
interface DifferentActionIdentifyEmotionalUrgesEntryCardProps {
    entry: DifferentActionIdentifyEmotionalUrgesEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const DifferentActionIdentifyEmotionalUrgesEntryCard: React.FC<DifferentActionIdentifyEmotionalUrgesEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
