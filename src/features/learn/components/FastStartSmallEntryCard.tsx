...
export interface FastStartSmallEntry {
    id: string;
    date: string;
    time?: string;
    smallRequest?: string;
    ...
    biggerChallengeOutcome?: string;
    learnedAboutFast?: string;
    nextSteps?: string;
}

interface FastStartSmallEntryCardProps {
    entry: FastStartSmallEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const FastStartSmallEntryCard: React.FC<FastStartSmallEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
        ...
        >
            ...
            {entry.smallRequest && (
                <Text style={[t.textRegular, { color: colors.text_secondary }]}>
                    Small Request: {truncateText(entry.smallRequest)}
                </Text>
            )}
        </View>
    );
