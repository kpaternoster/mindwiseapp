...
export interface SelfValidationPracticeEntry {
    ...
    offerCompassion: string;
}

interface SelfValidationPracticeEntryCardProps {
    entry: SelfValidationPracticeEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const SelfValidationPracticeEntryCard: React.FC<SelfValidationPracticeEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
