...
export interface RadicalAcceptanceCopingStatementsListEntry {
    id: string;
    date: string;
    time?: string;
    statements?: string[];
...
interface RadicalAcceptanceCopingStatementsListEntryCardProps {
    entry: RadicalAcceptanceCopingStatementsListEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const RadicalAcceptanceCopingStatementsListEntryCard: React.FC<RadicalAcceptanceCopingStatementsListEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
