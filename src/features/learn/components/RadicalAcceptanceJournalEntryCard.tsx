...
export interface RadicalAcceptanceJournalEntry {
    id: string;
    date: string;
    time?: string;
    situation?: string;
...
interface RadicalAcceptanceJournalEntryCardProps {
    entry: RadicalAcceptanceJournalEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const RadicalAcceptanceJournalEntryCard: React.FC<RadicalAcceptanceJournalEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
