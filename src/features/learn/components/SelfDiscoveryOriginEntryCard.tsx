...
export interface SelfDiscoveryOriginEntry {
    id: string;
    date: string;
    time?: string;
    unhelpfulStories?: Array<{ id: number; story: string }>;
    originStoryPairs?: Array<{ id: number; story: string; origin: string }>;
    compassion?: string;
}

interface SelfDiscoveryOriginEntryCardProps {
    entry: SelfDiscoveryOriginEntry;
    onView: (entryId: string) => void;
    onDelete: (entryId: string) => void;
}

export const SelfDiscoveryOriginEntryCard: React.FC<SelfDiscoveryOriginEntryCardProps> = ({
    entry,
    onView,
    onDelete,
}) => {
