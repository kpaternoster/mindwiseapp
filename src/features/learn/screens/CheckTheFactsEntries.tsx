...
export default function CheckTheFactsEntriesScreen() {
    ...
    useEffect(() => {
        ...
        const mockEntries: CheckTheFactsEntry[] = [
            {
                id: '1',
                date: new Date(2025, 11, 4).toISOString(), // Dec 4, 2025
                describeSituation: 'Argument with partner',
                facts: 'Snapped at me, Walked away',
                assumptions: 'They don\'t care, They\'re angry',
                alternativeExplanations: 'Bad day, Distracted, Misunderstanding',
                emotionFactsCheck: 'My emotions matched my assumptions more than the facts',
            },
        ];
