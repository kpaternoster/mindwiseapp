...
import aboutSUDSData from '../data/aboutSUDS.json';

export default function AboutSUDSScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText, footerText } = aboutSUDSData;
    ...
    return (
        <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
            ...
            >
                ...
                {/* Footer Text */}
                <Text style={[t.textRegular, { color: colors.text_secondary, backgroundColor: colors.cream_40 }]} 
                    className="mb-20 rounded-2xl p-4">
                    {footerText}
                </Text>
            </ScrollView>
        </View>
