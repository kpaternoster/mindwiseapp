...
import interpersonalGoalsData from '../data/interpersonalGoals.json';

export default function InterpersonalGoalsScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = interpersonalGoalsData;
