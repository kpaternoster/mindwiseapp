...
import dialecticalThinkingData from '../data/dialecticalThinking.json';

export default function DialecticalThinkingScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = dialecticalThinkingData;
        ...
        <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
            ...
            >
                ...
                <Pressable
                    ...
                    onPress={() => dissolveTo('Learn_DialecticalThinkingExercises')}
                >
