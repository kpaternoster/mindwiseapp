...
import aboutSTUNWAVEData from '../data/aboutSTUNWAVE.json';

export default function AboutSTUNWAVEScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText, footerText } = aboutSTUNWAVEData;
        ...
        <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
            ...
            >
                ...
                <Pressable
                    ...
                    onPress={() => dissolveTo('Learn_STUNWAVEExercises')}
                >
