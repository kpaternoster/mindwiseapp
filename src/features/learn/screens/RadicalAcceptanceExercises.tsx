...
import radicalAcceptanceExercisesData from '../data/radicalAcceptanceExercises.json';

export default function RadicalAcceptanceExercisesScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, introText, exercises } = radicalAcceptanceExercisesData;

    const handleExercisePress = (exercise: any) => {
        if (exercise.title === 'Acceptance Journal') {
            dissolveTo('Learn_RadicalAcceptanceJournal');
        } else if (exercise.title === 'Coping Statements List') {
            dissolveTo('Learn_RadicalAcceptanceCopingStatementsList');
        } else {
