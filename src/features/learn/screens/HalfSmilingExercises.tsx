...
import halfSmilingExercisesData from '../data/halfSmilingExercises.json';

export default function HalfSmilingExercisesScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, introText, exercises } = halfSmilingExercisesData;

    const handleExercisePress = (exercise: any) => {
        if (exercise.title === 'Mindful Half-Smile Practice') {
            dissolveTo('Learn_HalfSmilingMindfulHalfSmilePractice');
        } else if (exercise.title === 'Emotion Mapping') {
            dissolveTo('Learn_HalfSmilingEmotionMapping');
        } else if (exercise.title === 'Half-Smile in Action') {
            dissolveTo('Learn_HalfSmilingAction');
        } else if (exercise.title === 'Anchor Prompts') {
            dissolveTo('Learn_HalfSmilingAnchorPrompt');
        } else {
