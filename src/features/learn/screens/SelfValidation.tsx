...
import selfValidationData from '../data/selfValidation.json';

export default function SelfValidationScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = selfValidationData;

    const handleButtonPress = () => {
        dissolveTo('Learn_SelfValidationExercises');
    };
