...
import { HeartIcon, ArrowRightIcon } from '@components/Utils';
import selfDiscoveryExercisesData from '../data/selfDiscoveryExercises.json';

export default function SelfDiscoveryExercisesScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, introText, introTitle, exercises, bePatientCard } = selfDiscoveryExercisesData;
    ...
    const handleExercisePress = (exercise: any) => {
        ...
        switch (exercise.title) {
            case 'Origins':
                dissolveTo('Learn_SelfDiscoveryOrigins');
                break;
            default:
                console.log('Exercise pressed:', exercise.title);
                break;
