...
import improveExercisesData from '../data/improveExercises.json';

export default function ImproveExercisesScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, introText, exercises } = improveExercisesData;

    const handleExercisePress = (exercise: any) => {
        switch (exercise.title) {
            case 'Identify Triggers':
                dissolveTo('Learn_IdentifyTriggers');
                break;
            case 'Create a Personalized Toolkit':
                dissolveTo('Learn_CreateAPersonalizedToolkit');
                break;
            default:
