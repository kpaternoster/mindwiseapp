...
import halfSmilingData from '../data/halfSmiling.json';

export default function HalfSmilingScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = halfSmilingData;

    const handleButtonPress = () => {
        // TODO: Navigate to Half Smile Exercises screen when created
        dissolveTo('Learn_HalfSmilingExercises');
    };
