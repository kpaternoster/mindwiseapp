...
import emotionsWheelData from '../data/emotionsWheel.json';

export default function EmotionsWheelScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = emotionsWheelData;
    ...
    return (
        <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
            ...
            >
                ...
                {/* Bottom Button */}
                <Pressable
                    className="rounded-full py-4 px-3 flex-row items-center justify-center mb-6"
                    style={{ backgroundColor: colors.Button_Orange }}
                    onPress={() => dissolveTo('Learn_EmotionsWheelExercises')}
                >
