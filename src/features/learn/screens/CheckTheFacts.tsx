...
import checkTheFactsData from '../data/checkTheFacts.json';

export default function CheckTheFactsScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = checkTheFactsData;
        ...
        <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
            ...
            >
                ...
                <Pressable
                    ...
                    onPress={() => dissolveTo('Learn_CheckTheFactsExercises')}
                >
