...
import positiveSelfTalkData from '../data/positiveSelfTalk.json';

export default function PositiveSelfTalkScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = positiveSelfTalkData;

    const handleButtonPress = () => {
        dissolveTo('Learn_PositiveSelfTalkExercises');
    };
