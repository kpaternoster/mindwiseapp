...
import buildSelfLoveData from '../data/buildSelfLove.json';
import { PlantIcon } from '@components/Utils';

export default function BuildSelfLoveScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, totalSkills, completedSkills, progressPercentage, sections, skills, keepLearning } = buildSelfLoveData;
    ...
    const handleSkillPress = (skill: any) => {
        ...
        switch (skill.title) {
            case 'Self Discovery':
                dissolveTo('Learn_SelfDiscovery');
                break;
            case 'Self-Talk':
                dissolveTo('Learn_PositiveSelfTalk');
                break;
                case 'Self Validation':
                    dissolveTo('Learn_SelfValidation');
                    break;
            default:
