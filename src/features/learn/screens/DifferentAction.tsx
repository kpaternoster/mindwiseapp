...
import differentActionData from '../data/differentAction.json';

export default function DifferentActionScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = differentActionData;

    const handleButtonPress = () => {
        dissolveTo('Learn_DifferentActionExercises');
    };
