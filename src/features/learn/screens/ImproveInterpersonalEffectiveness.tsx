...
import interpersonalEffectivenessData from '../data/interpersonalEffectiveness.json';
import { PlantIcon } from '@components/Utils';

export default function ImproveInterpersonalEffectivenessScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, totalSkills, completedSkills, progressPercentage, sections, skills, keepLearning } = interpersonalEffectivenessData;
