...
import tippExercisesData from '../data/tippExercises.json';

export default function TIPPExercisesScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, introText, exercises } = tippExercisesData;
            ...
            >
                ...
                {exercises.map((exercise) => {
                    if (exercise.hasHeartIcon) {
                        // Custom card for "Be Patient With Yourself" with heart icon and pink background
                        return (
                            <View
                                key={exercise.id}
