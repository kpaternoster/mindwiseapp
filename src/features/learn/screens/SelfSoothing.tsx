...
import selfSoothingData from '../data/selfSoothing.json';

export default function SelfSoothingScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = selfSoothingData;

    const handleButtonPress = () => {
        dissolveTo('Learn_SelfSoothingExercises');
    };
