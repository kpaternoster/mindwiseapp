...
import validatingOthersData from '../data/validatingOthers.json';

export default function ValidatingOthersScreen() {
    const { dissolveTo } = useDissolveNavigation();
    const { title, sections, buttonText } = validatingOthersData;
