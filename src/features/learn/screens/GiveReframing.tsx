...
export default function GiveReframingScreen() {
    ...
    const { title, intro, sections, buttons } = giveReframingData;

    const [expandedSections, setExpandedSections] = useState<{ [key: string]: boolean }>({
        recallConversation: true,
        withoutGive: true,
        reframeUsingGive: true,
        fullGiveConversation: true,
        reflectOnDifference: true,
    });
            ...
            <View className="flex-1 bg-white pt-9" style={{ backgroundColor: colors.white }}>
                ...
                >
                    ...
                    {sections.map((section) => {
                        // Sections with subsections (Reframe Using GIVE, Reflect on the Difference)
                                        ...
                                        >
                                            {section.subsections.map((subsection: any) => (
                                                <View key={subsection.id} className="mb-4">
                                                    ...
                                                    {(subsection as any).hint && (
                                                        <View className="mb-3 p-3 rounded-xl" style={{ backgroundColor: colors.orange_50 }}>
